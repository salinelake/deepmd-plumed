...
private:
  ...
  void _feed_plumed(std::vector<double> & dipole, std::vector<double> & force, std::vector<double> & virial);
  void _calculate_omp(const std::vector< Vector >  & positions, std::vector<double> & dipole, std::vector<double> & force, std::vector<double> & virial);
  void _calculate_bond( unsigned & id_bond, const std::vector< Vector >  & positions, std::vector<double> & _dipole, std::vector<double> & _force, std::vector<double> & _virial);
